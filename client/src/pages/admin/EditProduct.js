            ...
            <div className="flex justify-between items-center mb-8">
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="flex items-center gap-2 text-gray-600 hover:text-yellow-500 transition-all hover:gap-3"
                    >
                        <FaArrowLeft /> Back to Products
                    </button>
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">Edit Product</h1>
                </div>
                <button
                    onClick={() => navigate('/admin/products')}
